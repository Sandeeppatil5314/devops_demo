...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		// {
			// path: '/form/data-migrate', title: 'Data Migration', icon: 'file-text', type: 'link'
		// },
		
		{
			path: '/form/google-map', title: 'Main Dashboard', icon: 'map', type: 'link'
		},
		// {
        //    path: '/from/summary-dashboard', title: 'Summary Dashboard', icon: 'bar-chart', type: 'link'
		// },
		{
			path: '/form/travelHistory', title: 'Travel History', icon: 'file-text', type: 'link'
		},
		{
			path: '/form/violation', title: 'Violation Report', icon: 'file-text', type: 'link'
		},
		{
			path: '/form/Safety', title: 'Safety', icon: 'server', type: 'link'
		},
		{
			path: '/form/DistanceTravel', title: 'Distance Travel', icon: 'package', type: 'link'
		},
		{
			path: '/form/FleetMaster', title: 'Fleet Master', icon: 'git-pull-request', type: 'link'
		}
		
		/* 
		{
			path: '/form/data-catalog', title: 'Data Catalog', icon: 'box', type: 'link'
		},
		{
			path: '/form/data-tables', title: 'Migrated Data', icon: 'airplay', type: 'link'
		} *//* 
		{
			path: '/form/pipeline', title: 'Pipeline', icon: 'airplay', type: 'link'
		} *//* ,
		{
